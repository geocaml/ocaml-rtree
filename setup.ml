...
(* OASIS_START *)
(* DO NOT EDIT (digest: e43d496ffd11805d50b3f43429434438) *)
(*
...
# 21 "/home/mlavigne/ocamlbrew/ocaml-4.00.0/build/odb/install-oasis/oasis-0.3.0/src/plugins/custom/CustomPlugin.ml"
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Rtree"; "Rtree_f"; "Envelope"];
                      lib_pack = false;
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "-g\217F2JyB\190+\024+\b\151\199\019";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
